            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                    <td style="padding: 30px 30px 20px;">
                        ...
                        <p style="font-size: 16px; margin-bottom: 20px;">Thank you for choosing Our Luxury Hotel for your upcoming stay. We're delighted to confirm your booking.</p>
                        ...
                        <p style="font-size: 16px; margin-bottom: 20px;">If you have any questions or need to modify your booking, please contact our front desk:</p>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                    <td align="center" valign="top" style="padding: 30px 0; background-color: #1E40AF;">
                        <p style="color: #FFFFFF; font-size: 14px; margin: 0;">&copy; 2023 Our Luxury Hotel. All rights reserved.</p>
                    </td>
                </tr>
            </table>
        </div>
