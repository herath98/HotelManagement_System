...
const OTPVerification = () => {
  ...
  return (
    ...
    <div className='flex w-32 h-32 justify-center mx-auto items-center border-[5px] rounded-full mb-4 text-[#212B37] font-bold'>
        ...
        <h2 className="text-2xl flex justify-center font-bold mb- text-black">OTP Verification</h2>
        <p className='flex justify-center mb-6 text-[#6E829F]'>Verify your OTP</p>
      <form className='space-y-4' onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full bg-blue-400 text-white py-2 rounded hover:bg-opacity-90 transition duration-300"
        >
          Verify OTP
        </button>
      </form>
